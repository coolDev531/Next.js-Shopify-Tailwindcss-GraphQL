    ...
    <Wrapper maxWidth="xl" paddingY="base">
      <figure className="relative mx-auto max-w-prose px-4">
        <div className="absolute inset-0 -z-20 flex h-[84%] select-none items-center justify-center">
          <div className="relative aspect-1 h-full rounded-[0_0_100%_0] bg-sky-200/40 dark:bg-slate-800/60">
        ...
        <blockquote
          className={clsx(
            "relative mb-3 max-w-xl text-base leading-relaxed tracking-tight text-slate-600 dark:text-slate-300 md:text-lg xl:max-w-2xl",
