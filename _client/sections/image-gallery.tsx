...
import { ImageGallerySection } from ".shopify-cms/types/sections";
            ...
            >
              {settings.image1
                ? <Image
                    ...
                    alt={settings?.image1?.alt || settings.title1 || "Gallery Image 1"}
                    maxWidth={300}
                  />
                : <Image
                    className="h-full bg-center object-cover"
            ...
            >
              {settings.image2
                ? <Image
                    ...
                    alt={settings?.image2?.alt || settings.title2 || "Gallery Image 2"}
                    maxWidth={600}
                  />
                : <Image
                    className="h-full bg-center object-cover"
            ...
            >
              {settings.image3
                ? <Image
                    ...
                    alt={settings?.image3?.alt || settings.title3 || "Gallery Image 3"}
                    maxWidth={350}
                  />
                : <Image
                    className="h-full bg-center object-cover"
            ...
            >
              {settings.image4
                ? <Image
                    ...
                    alt={settings?.image4?.alt || settings.title4 || "Gallery Image 4"}
                    maxWidth={520}
                  />
                : <Image
                    className="h-full bg-center object-cover"
            ...
            >
              {settings.image5
                ? <Image
                    ...
                    alt={settings?.image5?.alt || settings.title5 || "Gallery Image 5"}
                    maxWidth={500}
                  />
                : <Image
                    className="h-full bg-center object-cover"
            ...
            >
              {settings.image6
                ? <Image
                    ...
                    alt={settings?.image6?.alt || settings.title6 || "Gallery Image 6"}
                    maxWidth={290}
                  />
                : <Image
                    className="h-full bg-center object-cover"
