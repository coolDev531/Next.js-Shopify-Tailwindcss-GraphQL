...
import backgroundImage from "public/images/bg-gradient-templates.png";
...
export const HeroWithFeatures: FC<HeroWithFeaturesSection> = ({ id, settings, blocks, type }) => {
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="absolute inset-y-0 hidden w-full min-w-[1360px] bg-[url('/_next/image?url=%2Fimages%2Fbg-gradient-templates.png&w=1200&q=10')] bg-[length:2000px_100%] bg-[position:calc(50%_+_220px)_-50px] bg-no-repeat lg:block" />
      <Wrapper
        maxWidth="xl"
            ...
            <header>
              ...
              <div className="mt-4 flex flex-wrap gap-6">
                {settings.tech.map((product) => {
                  const icon = product.metafields["react_icon"]?.value;
                  if (icon) {
                    return (
                      <figure
