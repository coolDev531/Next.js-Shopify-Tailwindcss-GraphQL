...
const LightDarkSwitcher: FC = () => {
  ...
  return (
    <motion.button
      title="Theme toggle"
      className="relative flex h-8 w-8 items-center justify-center rounded transition-colors transition-all duration-75 hfa:bg-slate-200 hfa:text-slate-900 h:!text-orange-600 h:shadow-glowLight dark:hfa:bg-slate-700 dark:hfa:text-white dark:h:!text-sky-500 dark:h:shadow-glowDark"
